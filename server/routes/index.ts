...
import plexStreamsRoutes from './plexStreams';
import tautulliTopUsersRoutes from './tautulliTopUsers';
...
router.use('/plexstreams', isAuthenticated(), plexStreamsRoutes);
router.use('/tautulli', isAuthenticated(), tautulliTopUsersRoutes);
